...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/2.stencil_testing/stencil_testing.cpp</title>
...
int main()
{
   ...
   <function id='69'> glStencilOp(</function>GL_KEEP, GL_KEEP, GL_REPLACE);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.vs' target='_blank'>2.stencil_testing.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.fs' target='_blank'>2.stencil_testing.fs</a>");
    Shader shaderSingleColor("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/2.stencil_testing/2.stencil_testing.vs' target='_blank'>2.stencil_testing.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/2.stencil_testing/2.stencil_single_color.fs' target='_blank'>2.stencil_single_color.fs</a>");
   ...
   <function id='27'> glBindVertexArray(</function>0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT); // don't forget to clear the stencil buffer!
       ...
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, cubeTexture);
        model = glm::mat4(1.0f);
        model =<function id='55'> glm::translate(</function>model, glm::vec3(-1.0f, 0.0f, -1.0f));
        model =<function id='56'> glm::scale(</function>model, glm::vec3(scale, scale, scale));
       ...
       <function id='27'> glBindVertexArray(</function>0);
       <function id='67'> glStencilMask(</function>0xFF);
       <function id='68'> glStencilFunc(</function>GL_ALWAYS, 0, 0xFF);
       <function id='60'> glEnable(</function>GL_DEPTH_TEST);
