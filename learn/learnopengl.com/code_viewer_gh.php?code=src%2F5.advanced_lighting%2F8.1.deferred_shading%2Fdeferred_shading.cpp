...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/8.1.deferred_shading/deferred_shading.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shaderGeometryPass("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.1.deferred_shading/8.1.g_buffer.vs' target='_blank'>8.1.g_buffer.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.1.deferred_shading/8.1.g_buffer.fs' target='_blank'>8.1.g_buffer.fs</a>");
    Shader shaderLightingPass("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.1.deferred_shading/8.1.deferred_shading.vs' target='_blank'>8.1.deferred_shading.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.1.deferred_shading/8.1.deferred_shading.fs' target='_blank'>8.1.deferred_shading.fs</a>");
    Shader shaderLightBox("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.1.deferred_shading/8.1.deferred_light_box.vs' target='_blank'>8.1.deferred_light_box.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.1.deferred_shading/8.1.deferred_light_box.fs' target='_blank'>8.1.deferred_light_box.fs</a>");
