...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/6.2.coordinate_systems_depth/coordinate_systems_depth.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.vs' target='_blank'>6.2.coordinate_systems.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.fs' target='_blank'>6.2.coordinate_systems.fs</a>");
   ...
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // also clear the depth buffer now!
       ...
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, texture2);
        ...
        model =<function id='57'> glm::rotate(</function>model, (float<function id='47'>)glfwGetTime(</function>), glm::vec3(0.5f, 1.0f, 0.0f));
        view  =<function id='55'> glm::translate(</function>view, glm::vec3(0.0f, 0.0f, -3.0f));
        projection = glm::perspective<function id='63'>(glm::radians(</function>45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
        // retrieve the matrix uniform locations
        unsigned int modelLoc =<function id='45'> glGetUniformLocation(</function>ourShader.ID, &quot;model&quot;);
        unsigned int viewLoc  =<function id='45'> glGetUniformLocation(</function>ourShader.ID, &quot;view&quot;);
        // pass them to the shaders (3 different ways)
       <function id='44'> glUniformM</function>atrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
       <function id='44'> glUniformM</function>atrix4fv(viewLoc, 1, GL_FALSE, &amp;view[0][0]);
