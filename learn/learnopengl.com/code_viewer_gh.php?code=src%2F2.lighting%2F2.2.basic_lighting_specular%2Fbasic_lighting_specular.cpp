...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader lightingShader("<a href='code_viewer_gh.php?code=src/2.lighting/2.2.basic_lighting_specular/2.2.basic_lighting.vs' target='_blank'>2.2.basic_lighting.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/2.2.basic_lighting_specular/2.2.basic_lighting.fs' target='_blank'>2.2.basic_lighting.fs</a>");
    Shader lightCubeShader("<a href='code_viewer_gh.php?code=src/2.lighting/2.2.basic_lighting_specular/2.2.light_cube.vs' target='_blank'>2.2.light_cube.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/2.2.basic_lighting_specular/2.2.light_cube.fs' target='_blank'>2.2.light_cube.fs</a>");
