...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/2.lighting/5.4.light_casters_spot_soft/light_casters_spot_soft.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader lightingShader("<a href='code_viewer_gh.php?code=src/2.lighting/5.4.light_casters_spot_soft/5.4.light_casters.vs' target='_blank'>5.4.light_casters.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/5.4.light_casters_spot_soft/5.4.light_casters.fs' target='_blank'>5.4.light_casters.fs</a>");
    Shader lightCubeShader("<a href='code_viewer_gh.php?code=src/2.lighting/5.4.light_casters_spot_soft/5.4.light_cube.vs' target='_blank'>5.4.light_cube.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/5.4.light_casters_spot_soft/5.4.light_cube.fs' target='_blank'>5.4.light_cube.fs</a>");
   ...
   <function id='29'><function id='60'> glEnableV</function>ertexAttribArray(</function>0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        lightingShader.setFloat(&quot;light.outerCutOff&quot;, glm::cos<function id='63'>(glm::radians(</function>17.5f)));
