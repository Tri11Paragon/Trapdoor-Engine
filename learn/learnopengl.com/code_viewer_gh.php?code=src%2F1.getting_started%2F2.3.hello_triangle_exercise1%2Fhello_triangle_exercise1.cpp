...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/2.3.hello_triangle_exercise1/hello_triangle_exercise1.cpp</title>
...
int main()
{
   ...
   <function id='27'> glBindVertexArray(</function>0); 
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='1'> glDrawArrays(</function>GL_TRIANGLES, 0, 6); // set the count to 6 since we're drawing 6 vertices now (2 triangles); not 3!
