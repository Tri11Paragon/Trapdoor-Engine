...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/7.2.camera_keyboard_dt/camera_keyboard_dt.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/7.2.camera_keyboard_dt/7.2.camera.vs' target='_blank'>7.2.camera.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/7.2.camera_keyboard_dt/7.2.camera.fs' target='_blank'>7.2.camera.fs</a>");
   ...
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, texture2);
        ...
        glm::mat4 view =<function id='62'> glm::lookAt(</function>cameraPos, cameraPos + cameraFront, cameraUp);
