...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/4.5.textures_exercise3/textures_exercise3.cpp</title>
...
int main()
{
   ...
   <function id='19'> glfwMakeContextCurrent(</function>window);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/4.5.textures_exercise3/4.4.texture.vs' target='_blank'>4.4.texture.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/4.5.textures_exercise3/4.4.texture.fs' target='_blank'>4.4.texture.fs</a>");
   ...
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST); // set texture filtering to nearest neighbor to clearly see the texels/pixels
