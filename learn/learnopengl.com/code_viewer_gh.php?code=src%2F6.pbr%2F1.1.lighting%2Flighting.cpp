...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/6.pbr/1.1.lighting/lighting.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/6.pbr/1.1.lighting/1.1.pbr.vs' target='_blank'>1.1.pbr.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/1.1.lighting/1.1.pbr.fs' target='_blank'>1.1.pbr.fs</a>");
