...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/1.1.depth_testing/depth_testing.cpp</title>
...
int main()
{
   ...
   <function id='66'> glDepthFunc(</function>GL_ALWAYS); // always pass the depth test (same effect as glDisable(GL_DEPTH_TEST))

    // build and compile shaders
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/1.1.depth_testing/1.1.depth_testing.vs' target='_blank'>1.1.depth_testing.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/1.1.depth_testing/1.1.depth_testing.fs' target='_blank'>1.1.depth_testing.fs</a>");
