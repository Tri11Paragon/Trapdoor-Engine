...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/3.1.shaders_uniform/shaders_uniform.cpp</title>
   ...
   <function id='27'> glBindVertexArray(</function>VAO);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT);
        ...
        // be sure to activate the shader before any calls to<function id='44'> glUniform
</function>       <function id='28'> glUseProgram(</function>shaderProgram);
       ...
       <function id='44'> glUniform4</function>f(vertexColorLocation, 0.0f, greenValue, 0.0f, 1.0f);
