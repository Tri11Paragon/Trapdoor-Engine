...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/6.4.coordinate_systems_exercise3/coordinate_systems_exercise3.cpp</title>
...
for(unsigned int i = 0; i &lt; 10; i++)
{
    ...
    if(i % 3 == 0)  // every 3rd iteration (including the first) we set the angle using GLFW's time function.
        angle =<function id='47'> glfwGetTime(</function>) * 25.0f;
