...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/2.lighting/5.2.light_casters_point/light_casters_point.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader lightingShader("<a href='code_viewer_gh.php?code=src/2.lighting/5.2.light_casters_point/5.2.light_casters.vs' target='_blank'>5.2.light_casters.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/5.2.light_casters_point/5.2.light_casters.fs' target='_blank'>5.2.light_casters.fs</a>");
    Shader lightCubeShader("<a href='code_viewer_gh.php?code=src/2.lighting/5.2.light_casters_point/5.2.light_cube.vs' target='_blank'>5.2.light_cube.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/5.2.light_casters_point/5.2.light_cube.fs' target='_blank'>5.2.light_cube.fs</a>");
