...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/3.1.blending_discard/blending_discard.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/3.1.blending_discard/3.1.blending.vs' target='_blank'>3.1.blending.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/3.1.blending_discard/3.1.blending.fs' target='_blank'>3.1.blending.fs</a>");
   ...
   <function id='33'> glGenVertexArrays(</function>1, &amp;transparentVAO);
   <function id='12'> glGenBuffers(</function>1, &amp;transparentVBO);
   <function id='27'> glBindVertexArray(</function>transparentVAO);
   <function id='32'> glBindBuffer(</function>GL_ARRAY_BUFFER, transparentVBO);
   <function id='31'> glBufferData(</function>GL_ARRAY_BUFFER, sizeof(transparentVertices), transparentVertices, GL_STATIC_DRAW);
   <function id='29'><function id='60'> glEnableV</function>ertexAttribArray(</function>0);
   <function id='30'> glVertexAttribPointer(</function>0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)0);
   <function id='29'><function id='60'> glEnableV</function>ertexAttribArray(</function>1);
   <function id='30'> glVertexAttribPointer(</function>1, 2, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)(3 * sizeof(float)));
   <function id='27'> glBindVertexArray(</function>0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='1'> glDrawArrays(</function>GL_TRIANGLES, 0, 6);
        // vegetation
       <function id='27'> glBindVertexArray(</function>transparentVAO);
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, transparentTexture);
