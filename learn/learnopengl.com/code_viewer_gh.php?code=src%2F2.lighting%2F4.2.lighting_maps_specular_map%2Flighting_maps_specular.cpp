...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/2.lighting/4.2.lighting_maps_specular_map/lighting_maps_specular.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader lightingShader("<a href='code_viewer_gh.php?code=src/2.lighting/4.2.lighting_maps_specular_map/4.2.lighting_maps.vs' target='_blank'>4.2.lighting_maps.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/4.2.lighting_maps_specular_map/4.2.lighting_maps.fs' target='_blank'>4.2.lighting_maps.fs</a>");
    Shader lightCubeShader("<a href='code_viewer_gh.php?code=src/2.lighting/4.2.lighting_maps_specular_map/4.2.light_cube.vs' target='_blank'>4.2.light_cube.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/4.2.lighting_maps_specular_map/4.2.light_cube.fs' target='_blank'>4.2.light_cube.fs</a>");
