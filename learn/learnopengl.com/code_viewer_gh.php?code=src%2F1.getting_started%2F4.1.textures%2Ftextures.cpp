...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/4.1.textures/textures.cpp</title>
...
int main()
{
   ...
   <function id='19'> glfwMakeContextCurrent(</function>window);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/4.1.textures/4.1.texture.vs' target='_blank'>4.1.texture.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/4.1.textures/4.1.texture.fs' target='_blank'>4.1.texture.fs</a>"); 
   ...
   <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, texture); // all upcoming GL_TEXTURE_2D operations now have effect on this texture object
    // set the texture wrapping parameters
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);	// set texture wrapping to GL_REPEAT (default wrapping method)
