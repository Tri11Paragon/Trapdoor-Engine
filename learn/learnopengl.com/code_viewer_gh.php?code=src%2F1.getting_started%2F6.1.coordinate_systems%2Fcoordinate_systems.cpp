...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/6.1.coordinate_systems/coordinate_systems.cpp</title>
...
int main()
{
   ...
   <function id='19'> glfwMakeContextCurrent(</function>window);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.vs' target='_blank'>6.1.coordinate_systems.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.fs' target='_blank'>6.1.coordinate_systems.fs</a>");
