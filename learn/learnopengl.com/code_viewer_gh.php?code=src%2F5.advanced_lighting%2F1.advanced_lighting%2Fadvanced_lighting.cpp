...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/1.advanced_lighting/advanced_lighting.cpp</title>
...
int main()
{
   ...
   <function id='70'> glBlendFunc(</function>GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/1.advanced_lighting/1.advanced_lighting.vs' target='_blank'>1.advanced_lighting.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/1.advanced_lighting/1.advanced_lighting.fs' target='_blank'>1.advanced_lighting.fs</a>");
