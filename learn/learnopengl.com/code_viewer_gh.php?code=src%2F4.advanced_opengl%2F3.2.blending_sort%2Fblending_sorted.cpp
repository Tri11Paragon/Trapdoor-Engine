...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/3.2.blending_sort/blending_sorted.cpp</title>
...
int main()
{
   ...
   <function id='70'> glBlendFunc(</function>GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/3.2.blending_sort/3.2.blending.vs' target='_blank'>3.2.blending.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/3.2.blending_sort/3.2.blending.fs' target='_blank'>3.2.blending.fs</a>");
