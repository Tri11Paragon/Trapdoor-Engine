...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/5.1.framebuffers/framebuffers.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers.vs' target='_blank'>5.1.framebuffers.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers.fs' target='_blank'>5.1.framebuffers.fs</a>");
    Shader screenShader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers_screen.vs' target='_blank'>5.1.framebuffers_screen.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/5.1.framebuffers/5.1.framebuffers_screen.fs' target='_blank'>5.1.framebuffers_screen.fs</a>");
   ...
   <function id='77'> glBindFramebuffer(</function>GL_FRAMEBUFFER, 0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='13'><function id='10'> glClearC</function>olor(</function>1.0f, 1.0f, 1.0f, 1.0f); // set clear color to white (not really necessary actually, since we won't be able to see behind the quad anyways)
