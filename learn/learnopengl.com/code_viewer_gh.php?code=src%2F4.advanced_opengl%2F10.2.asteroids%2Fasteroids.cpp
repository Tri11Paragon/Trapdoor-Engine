...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/10.2.asteroids/asteroids.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/10.2.asteroids/10.2.instancing.vs' target='_blank'>10.2.instancing.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/10.2.asteroids/10.2.instancing.fs' target='_blank'>10.2.instancing.fs</a>");
