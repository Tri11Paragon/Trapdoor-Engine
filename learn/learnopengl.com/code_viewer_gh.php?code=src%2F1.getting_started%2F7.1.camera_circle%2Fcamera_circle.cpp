...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/7.1.camera_circle/camera_circle.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/7.1.camera_circle/7.1.camera.vs' target='_blank'>7.1.camera.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/7.1.camera_circle/7.1.camera.fs' target='_blank'>7.1.camera.fs</a>");
   ...
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    ...
    // -----------------------------------------------------------------------------------------------------------
    glm::mat4 projection = glm::perspective<function id='63'>(glm::radians(</function>45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, texture2);
        ...
        view =<function id='62'> glm::lookAt(</function>glm::vec3(camX, 0.0f, camZ), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
