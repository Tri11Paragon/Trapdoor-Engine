...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/8.guest/2021/1.scene/1.scene_graph/scene_graph.cpp</title>
...
<function id='60'>	glEnable(</function>GL_DEPTH_TEST);
	...
	// -------------------------
	Shader ourShader("<a href='code_viewer_gh.php?code=src/8.guest/2021/1.scene/1.scene_graph/1.model_loading.vs' target='_blank'>1.model_loading.vs</a>", "<a href='code_viewer_gh.php?code=src/8.guest/2021/1.scene/1.scene_graph/1.model_loading.fs' target='_blank'>1.model_loading.fs</a>");
