...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/8.2.deferred_shading_volumes/deferred_shading_volumes.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shaderGeometryPass("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.2.deferred_shading_volumes/8.2.g_buffer.vs' target='_blank'>8.2.g_buffer.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.2.deferred_shading_volumes/8.2.g_buffer.fs' target='_blank'>8.2.g_buffer.fs</a>");
    Shader shaderLightingPass("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.2.deferred_shading_volumes/8.2.deferred_shading.vs' target='_blank'>8.2.deferred_shading.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.2.deferred_shading_volumes/8.2.deferred_shading.fs' target='_blank'>8.2.deferred_shading.fs</a>");
    Shader shaderLightBox("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.2.deferred_shading_volumes/8.2.deferred_light_box.vs' target='_blank'>8.2.deferred_light_box.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/8.2.deferred_shading_volumes/8.2.deferred_light_box.fs' target='_blank'>8.2.deferred_light_box.fs</a>");
   ...
   <function id='50'> glGenTextures(</function>1, &amp;gAlbedoSpec);
   ...
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
   <function id='81'> glFramebufferTexture2D(</function>GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT2, GL_TEXTURE_2D, gAlbedoSpec, 0);
   ...
   <function id='77'> glBindFramebuffer(</function>GL_FRAMEBUFFER, 0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        {
            model = glm::mat4(1.0f);
            model =<function id='55'> glm::translate(</function>model, objectPositions[i]);
       ...
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, gAlbedoSpec);
        ...
        // ----------------------------------------------------------------------------------
       <function id='77'> glBindFramebuffer(</function>GL_READ_FRAMEBUFFER, gBuffer);
       <function id='77'> glBindFramebuffer(</function>GL_DRAW_FRAMEBUFFER, 0); // write to default framebuffer
        // blit to default framebuffer. Note that this may or may not work as the internal formats of both the FBO and default framebuffer have to match.
        // the internal formats are implementation defined. This works on all of my systems, but if it doesn't on yours you'll likely have to write to the 		
        // depth buffer in another shader stage (or somehow see to match the default framebuffer's internal format with the FBO's internal format).
       <function id='103'> glBlitFramebuffer(</function>0, 0, SCR_WIDTH, SCR_HEIGHT, 0, 0, SCR_WIDTH, SCR_HEIGHT, GL_DEPTH_BUFFER_BIT, GL_NEAREST);
       <function id='77'> glBindFramebuffer(</function>GL_FRAMEBUFFER, 0);
        ...
        {
            model = glm::mat4(1.0f);
            model =<function id='55'> glm::translate(</function>model, lightPositions[i]);
            model =<function id='56'> glm::scale(</function>model, glm::vec3(0.125f));
