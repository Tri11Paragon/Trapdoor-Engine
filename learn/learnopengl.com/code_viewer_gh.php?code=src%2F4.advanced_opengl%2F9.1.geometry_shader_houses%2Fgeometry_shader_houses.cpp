...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/9.1.geometry_shader_houses/geometry_shader_houses.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.1.geometry_shader_houses/9.1.geometry_shader.vs' target='_blank'>9.1.geometry_shader.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.1.geometry_shader_houses/9.1.geometry_shader.fs' target='_blank'>9.1.geometry_shader.fs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.1.geometry_shader_houses/9.1.geometry_shader.gs' target='_blank'>9.1.geometry_shader.gs</a>");
   ...
   <function id='31'> glBufferData(</function>GL_ARRAY_BUFFER, sizeof(points), &amp;points, GL_STATIC_DRAW);
   <function id='29'><function id='60'> glEnableV</function>ertexAttribArray(</function>0);
   <function id='30'> glVertexAttribPointer(</function>0, 2, GL_FLOAT, GL_FALSE, 5 * sizeof(float), 0);
