...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/4.advanced_opengl/9.3.geometry_shader_normals/normal_visualization.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.3.geometry_shader_normals/9.3.default.vs' target='_blank'>9.3.default.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.3.geometry_shader_normals/9.3.default.fs' target='_blank'>9.3.default.fs</a>");
    Shader normalShader("<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.3.geometry_shader_normals/9.3.normal_visualization.vs' target='_blank'>9.3.normal_visualization.vs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.3.geometry_shader_normals/9.3.normal_visualization.fs' target='_blank'>9.3.normal_visualization.fs</a>", "<a href='code_viewer_gh.php?code=src/4.advanced_opengl/9.3.geometry_shader_normals/9.3.normal_visualization.gs' target='_blank'>9.3.normal_visualization.gs</a>");
