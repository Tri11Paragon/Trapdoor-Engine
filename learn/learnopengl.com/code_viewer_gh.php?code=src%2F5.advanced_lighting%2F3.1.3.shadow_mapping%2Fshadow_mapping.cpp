...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/3.1.3.shadow_mapping/shadow_mapping.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.3.shadow_mapping/3.1.3.shadow_mapping.vs' target='_blank'>3.1.3.shadow_mapping.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.3.shadow_mapping/3.1.3.shadow_mapping.fs' target='_blank'>3.1.3.shadow_mapping.fs</a>");
    Shader simpleDepthShader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.3.shadow_mapping/3.1.3.shadow_mapping_depth.vs' target='_blank'>3.1.3.shadow_mapping_depth.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.3.shadow_mapping/3.1.3.shadow_mapping_depth.fs' target='_blank'>3.1.3.shadow_mapping_depth.fs</a>");
    Shader debugDepthQuad("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.3.shadow_mapping/3.1.3.debug_quad.vs' target='_blank'>3.1.3.debug_quad.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.3.shadow_mapping/3.1.3.debug_quad_depth.fs' target='_blank'>3.1.3.debug_quad_depth.fs</a>");
   ...
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_BORDER);
   <function id='15'> glTexParameteri</function>(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_BORDER);
    float borderColor[] = { 1.0, 1.0, 1.0, 1.0 };
   <function id='15'> glTexParameterf</function>v(GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, borderColor);
