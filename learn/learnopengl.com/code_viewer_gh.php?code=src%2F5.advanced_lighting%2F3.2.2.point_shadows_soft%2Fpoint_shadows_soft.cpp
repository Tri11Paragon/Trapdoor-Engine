...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/3.2.2.point_shadows_soft/point_shadows_soft.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_CULL_FACE);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.2.2.point_shadows_soft/3.2.2.point_shadows.vs' target='_blank'>3.2.2.point_shadows.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.2.2.point_shadows_soft/3.2.2.point_shadows.fs' target='_blank'>3.2.2.point_shadows.fs</a>");
    Shader simpleDepthShader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.2.2.point_shadows_soft/3.2.2.point_shadows_depth.vs' target='_blank'>3.2.2.point_shadows_depth.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.2.2.point_shadows_soft/3.2.2.point_shadows_depth.fs' target='_blank'>3.2.2.point_shadows_depth.fs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.2.2.point_shadows_soft/3.2.2.point_shadows_depth.gs' target='_blank'>3.2.2.point_shadows_depth.gs</a>");
