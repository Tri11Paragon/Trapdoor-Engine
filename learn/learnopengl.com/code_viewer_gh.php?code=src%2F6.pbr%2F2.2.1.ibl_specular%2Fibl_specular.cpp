...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/6.pbr/2.2.1.ibl_specular/ibl_specular.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_TEXTURE_CUBE_MAP_SEAMLESS);
    ...
    // -------------------------
    Shader pbrShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.pbr.vs' target='_blank'>2.2.1.pbr.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.pbr.fs' target='_blank'>2.2.1.pbr.fs</a>");
    Shader equirectangularToCubemapShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.cubemap.vs' target='_blank'>2.2.1.cubemap.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.equirectangular_to_cubemap.fs' target='_blank'>2.2.1.equirectangular_to_cubemap.fs</a>");
    Shader irradianceShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.cubemap.vs' target='_blank'>2.2.1.cubemap.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.irradiance_convolution.fs' target='_blank'>2.2.1.irradiance_convolution.fs</a>");
    Shader prefilterShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.cubemap.vs' target='_blank'>2.2.1.cubemap.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.prefilter.fs' target='_blank'>2.2.1.prefilter.fs</a>");
    Shader brdfShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.brdf.vs' target='_blank'>2.2.1.brdf.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.brdf.fs' target='_blank'>2.2.1.brdf.fs</a>");
    Shader backgroundShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.background.vs' target='_blank'>2.2.1.background.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.2.1.ibl_specular/2.2.1.background.fs' target='_blank'>2.2.1.background.fs</a>");
