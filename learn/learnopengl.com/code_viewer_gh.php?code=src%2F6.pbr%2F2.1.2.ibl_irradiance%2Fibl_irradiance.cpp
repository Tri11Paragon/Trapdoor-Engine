...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/6.pbr/2.1.2.ibl_irradiance/ibl_irradiance.cpp</title>
...
int main()
{
   ...
   <function id='66'> glDepthFunc(</function>GL_LEQUAL); // set depth function to less than AND equal for skybox depth trick.
    ...
    // -------------------------
    Shader pbrShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.pbr.vs' target='_blank'>2.1.2.pbr.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.pbr.fs' target='_blank'>2.1.2.pbr.fs</a>");
    Shader equirectangularToCubemapShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.cubemap.vs' target='_blank'>2.1.2.cubemap.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.equirectangular_to_cubemap.fs' target='_blank'>2.1.2.equirectangular_to_cubemap.fs</a>");
    Shader irradianceShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.cubemap.vs' target='_blank'>2.1.2.cubemap.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.irradiance_convolution.fs' target='_blank'>2.1.2.irradiance_convolution.fs</a>");
    Shader backgroundShader("<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.background.vs' target='_blank'>2.1.2.background.vs</a>", "<a href='code_viewer_gh.php?code=src/6.pbr/2.1.2.ibl_irradiance/2.1.2.background.fs' target='_blank'>2.1.2.background.fs</a>");
