...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/4.2.textures_combined/textures_combined.cpp</title>
...
int main()
{
   ...
   <function id='19'> glfwMakeContextCurrent(</function>window);
    ...
    // ------------------------------------
    Shader ourShader("<a href='code_viewer_gh.php?code=src/1.getting_started/4.2.textures_combined/4.2.texture.vs' target='_blank'>4.2.texture.vs</a>", "<a href='code_viewer_gh.php?code=src/1.getting_started/4.2.textures_combined/4.2.texture.fs' target='_blank'>4.2.texture.fs</a>");
