...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/3.1.2.shadow_mapping_base/shadow_mapping_base.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.2.shadow_mapping_base/3.1.2.shadow_mapping.vs' target='_blank'>3.1.2.shadow_mapping.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.2.shadow_mapping_base/3.1.2.shadow_mapping.fs' target='_blank'>3.1.2.shadow_mapping.fs</a>");
    Shader simpleDepthShader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.2.shadow_mapping_base/3.1.2.shadow_mapping_depth.vs' target='_blank'>3.1.2.shadow_mapping_depth.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.2.shadow_mapping_base/3.1.2.shadow_mapping_depth.fs' target='_blank'>3.1.2.shadow_mapping_depth.fs</a>");
    Shader debugDepthQuad("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.2.shadow_mapping_base/3.1.2.debug_quad.vs' target='_blank'>3.1.2.debug_quad.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/3.1.2.shadow_mapping_base/3.1.2.debug_quad_depth.fs' target='_blank'>3.1.2.debug_quad_depth.fs</a>");
