...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/2.lighting/2.3.basic_lighting_exercise1/basic_lighting_exercise1.cpp</title>
...
<pre style="width: 100%; height: 100%;"><code id="codez" style="margin:0; padding:25; border:0; border-radius:0;">int main()
{
    ...
    while(<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        lightPos.x = 1.0f + sin<function id='47'>(glfwGetTime(</function>)) * 2.0f;
        lightPos.y = sin<function id='47'>(glfwGetTime(</function>) / 2.0f) * 1.0f;
