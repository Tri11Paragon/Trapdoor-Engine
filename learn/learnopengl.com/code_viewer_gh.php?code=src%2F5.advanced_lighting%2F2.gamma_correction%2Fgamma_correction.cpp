...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/5.advanced_lighting/2.gamma_correction/gamma_correction.cpp</title>
...
int main()
{
   ...
   <function id='70'> glBlendFunc(</function>GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    ...
    // -------------------------
    Shader shader("<a href='code_viewer_gh.php?code=src/5.advanced_lighting/2.gamma_correction/2.gamma_correction.vs' target='_blank'>2.gamma_correction.vs</a>", "<a href='code_viewer_gh.php?code=src/5.advanced_lighting/2.gamma_correction/2.gamma_correction.fs' target='_blank'>2.gamma_correction.fs</a>");
   ...
   <function id='27'> glBindVertexArray(</function>0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='10'> glClear(</function>GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        // set light uniforms
       <function id='44'> glUniform3</function>fv<function id='45'>(glGetUniformLocation(</function>shader.ID, &quot;lightPositions&quot;), 4, &amp;lightPositions[0][0]);
       <function id='44'> glUniform3</function>fv<function id='45'>(glGetUniformLocation(</function>shader.ID, &quot;lightColors&quot;), 4, &amp;lightColors[0][0]);
        shader.setVec3(&quot;viewPos&quot;, camera.Position);
        shader.setInt(&quot;gamma&quot;, gammaEnabled);
        // floor
       <function id='27'> glBindVertexArray(</function>planeVAO);
       <function id='49'> glActiveTexture(</function>GL_TEXTURE0);
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, gammaEnabled ? floorTextureGammaCorrected : floorTexture);
