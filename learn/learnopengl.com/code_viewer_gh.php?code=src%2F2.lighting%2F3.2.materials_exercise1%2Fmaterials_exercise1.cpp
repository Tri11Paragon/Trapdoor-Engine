...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/2.lighting/3.2.materials_exercise1/materials_exercise1.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader lightingShader("<a href='code_viewer_gh.php?code=src/2.lighting/3.2.materials_exercise1/3.2.materials.vs' target='_blank'>3.2.materials.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/3.2.materials_exercise1/3.2.materials.fs' target='_blank'>3.2.materials.fs</a>");
    Shader lightCubeShader("<a href='code_viewer_gh.php?code=src/2.lighting/3.2.materials_exercise1/3.2.light_cube.vs' target='_blank'>3.2.light_cube.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/3.2.materials_exercise1/3.2.light_cube.fs' target='_blank'>3.2.light_cube.fs</a>");
