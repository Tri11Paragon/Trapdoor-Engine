...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/1.getting_started/2.2.hello_triangle_indexed/hello_triangle_indexed.cpp</title>
...
int main()
{
   ...
   <function id='32'> glBindBuffer(</function>GL_ARRAY_BUFFER, 0); 
    ...
    /<function id='32'>/glBindBuffer(</function>GL_ELEMENT_ARRAY_BUFFER, 0);
