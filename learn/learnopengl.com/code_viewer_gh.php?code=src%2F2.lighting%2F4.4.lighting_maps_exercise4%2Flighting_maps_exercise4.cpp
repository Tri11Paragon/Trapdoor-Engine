...
<head>
    <meta charset="utf-8"/>
	<title>Code Viewer. Source code: src/2.lighting/4.4.lighting_maps_exercise4/lighting_maps_exercise4.cpp</title>
...
int main()
{
   ...
   <function id='60'> glEnable(</function>GL_DEPTH_TEST);
    ...
    // ------------------------------------
    Shader lightingShader("<a href='code_viewer_gh.php?code=src/2.lighting/4.4.lighting_maps_exercise4/4.4.lighting_maps.vs' target='_blank'>4.4.lighting_maps.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/4.4.lighting_maps_exercise4/4.4.lighting_maps.fs' target='_blank'>4.4.lighting_maps.fs</a>");
    Shader lightCubeShader("<a href='code_viewer_gh.php?code=src/2.lighting/4.4.lighting_maps_exercise4/4.4.light_cube.vs' target='_blank'>4.4.light_cube.vs</a>", "<a href='code_viewer_gh.php?code=src/2.lighting/4.4.lighting_maps_exercise4/4.4.light_cube.fs' target='_blank'>4.4.light_cube.fs</a>");
   ...
   <function id='29'><function id='60'> glEnableV</function>ertexAttribArray(</function>0);
    ...
    while (<function id='14'>!glfwWindowShouldClose(</function>window))
    {
       ...
       <function id='48'> glBindTexture(</function>GL_TEXTURE_2D, emissionMap);
